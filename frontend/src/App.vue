  ...
  <div class="app-shell">
    <header class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <a class="gh-link" href="https://github.com/wenbochang888/github-trending-spider" target="_blank" rel="noreferrer" :aria-label="t('githubRepo')">
    ...
    >
      ...
      >
        <div class="history-drawer-head">
          <div>
            <h2 id="history-drawer-title">{{ t('historyDrawerTitle') }}</h2>
            <p>{{ t('historyDrawerDesc') }}</p>
          </div>
          <button class="history-drawer-close" type="button" @click="closeHistoryDrawer" :aria-label="t('close')">×</button>
        </div>

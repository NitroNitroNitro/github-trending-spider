  ...
  <div class="app-shell">
    <header class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <a class="gh-link" href="https://github.com/wenbochang888/github-trending-spider" target="_blank" rel="noreferrer" :aria-label="t('githubRepo')" :title="t('githubRepo')">
    ...
    >
      <aside class="history-drawer" @click.stop>
        <div class="history-drawer-head">
          ...
          <button class="history-drawer-close" type="button" :aria-label="t('close')" :title="t('close')" @click="closeHistoryDrawer">×</button>
        </div>
